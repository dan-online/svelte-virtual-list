...
describe('virtualListDebug utilities', () => {
    describe('shouldShowDebugInfo', () => {
        ...
        it('should return true when ranges differ', () => {
            const result = shouldShowDebugInfo({ start: 0, end: 10 }, { start: 5, end: 15 }, 100, 100);
            expect(result).toBe(true);
        });
        it('should return true when heights differ', () => {
            const result = shouldShowDebugInfo({ start: 0, end: 10 }, { start: 0, end: 10 }, 100, 150);
            expect(result).toBe(true);
        });
        it('should return false when nothing changes', () => {
            const result = shouldShowDebugInfo({ start: 0, end: 10 }, { start: 0, end: 10 }, 100, 100);
    ...
    describe('createDebugInfo', () => {
        it('should create correct debug info object', () => {
            ...
            const result = createDebugInfo(visibleRange, totalItems, processedItems, averageItemHeight);
