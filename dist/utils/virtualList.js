 ...
 */
export const calculateScrollPosition = (totalItems, itemHeight, containerHeight, gridColumns = 1) => {
    if (totalItems === 0)
        return 0;
 ...
 */
export const calculateVisibleRange = (scrollTop, viewportHeight, itemHeight, gridColumns = 1, totalItems, bufferSize, mode) => {
    if (gridColumns < 1)
        gridColumns = 1;
    const totalRows = Math.ceil(totalItems / gridColumns);
    if (mode === 'bottomToTop') {
 ...
 */
export const calculateTransformY = (mode, totalItems, visibleEnd, visibleStart, itemHeight, gridColumns = 1) => {
